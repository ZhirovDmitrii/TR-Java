...
class StringExpressionTests {
	...
	void testIsPositiveNumberLess1000()
	{
		...
		assertTrue(StringExpression.isPositiveNumberLess1000("10"));
		assertTrue(StringExpression.isPositiveNumberLess1000("100"));
	...
	void testPositiveNumberLessEquals255()
	{
		...
		assertTrue(StringExpression.isPositiveNumberLessEquals255("199"));
		assertTrue(StringExpression.isPositiveNumberLessEquals255("99"));
