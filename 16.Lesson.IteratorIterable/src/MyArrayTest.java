...
//		System.out.println(Arrays.toString(strings.toArray()));
	...
	public void testRemoveIf() {
		Integer[] arInteger = { 10, 7, 11, 13, 10, 2000 };
		String[] arString = { "lmn", "qwerty" };
		...
		assertArrayEquals(arInteger, numbers.toArray());
		...
		assertArrayEquals(arString, strings.toArray());
	}

	@Test
	public void testIndexOfPredicate() {
		assertEquals(0, numbers.indexOf(new Predicate<Integer>() {
		...
		assertEquals(0, strings.indexOf(new Predicate<String>() {
	...
	public void testLastIndexOfPredicate() {
		assertEquals(5, numbers.lastIndexOf(new Predicate<Integer>() {
...
//		assertEquals(3, strings.lastIndexOf(new StringLengthPredicate()));
	}
...
//	==============================================
	...
	void testIterator() {
		...
		for(Integer num: numbers) {
			assertEquals(arNumbers[ind++], num);
		}
	}
}